...
if (!inputFile) {
  console.error('Usage: node generate-v8.js <model.json>')
  process.exit(1)
}
...
// ================================================================
// schema.js — checkbox fields stored as json type
// ================================================================
function drizzleType(f) {
  switch (f.type) {
    ...
    case 'checkbox': return `json('${toCamel(f.field)}')`
...
// ================================================================
// repository.js
// — checkbox fields: JSON.stringify on write, JSON.parse on read
// ================================================================
const checkboxSerialize = hasCheckbox
  ? `
// serialize checkbox arrays to JSON strings before writing
